...
class Invoice(Document):
    ...
    netto = models.FloatField("Kwota netto", blank=False)
    brutto = models.FloatField("Kwota brutto", blank=False)
    ...
    payment_date = models.DateTimeField("Termin płatności", blank=True)
...
class Agreement(Document):
    agr_side = models.ForeignKey('AgreementSide',
                                 ...
                                 null=True,
                                 on_delete=models.SET_NULL)
    agr_date = models.DateTimeField("Data umowy", blank=False)
    agr_subject = models.TextField("Przedmiot umowy", blank=False)
...
class Other(Document):
    sender = models.ForeignKey("Sender",
                               ...
                               null=True,
                               on_delete=models.SET_NULL)
    description = models.TextField("Opis dokumentu", blank=False)
